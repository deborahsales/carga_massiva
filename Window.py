...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.arquivo_extraido = QtWidgets.QLineEdit(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.arquivo_extraido.sizePolicy().hasHeightForWidth())
        self.arquivo_extraido.setSizePolicy(sizePolicy)
        self.arquivo_extraido.setMinimumSize(QtCore.QSize(257, 50))
        self.arquivo_extraido.setMaximumSize(QtCore.QSize(16777215, 30))
        self.arquivo_extraido.setObjectName("arquivo_extraido")
        self.horizontalLayout_2.addWidget(self.arquivo_extraido)
        ...
        self.lista_usuarios = QtWidgets.QLineEdit(self.centralwidget)
        self.lista_usuarios.setMinimumSize(QtCore.QSize(257, 50))
        self.lista_usuarios.setObjectName("lista_usuarios")
        self.horizontalLayout.addWidget(self.lista_usuarios)
        spacerItem11 = QtWidgets.QSpacerItem(10, 10, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem11)
        self.botao_atualizada = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.botao_atualizada.sizePolicy().hasHeightForWidth())
        self.botao_atualizada.setSizePolicy(sizePolicy)
        self.botao_atualizada.setMinimumSize(QtCore.QSize(150, 50))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        self.botao_atualizada.setFont(font)
        self.botao_atualizada.setObjectName("botao_atualizada")
        self.horizontalLayout.addWidget(self.botao_atualizada)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Gerador de Carga Massiva Automática - Instituto Paramitas"))
        self.titulo.setText(_translate("MainWindow", "Gerador de Carga Massiva Automática"))
        self.label.setText(_translate("MainWindow", "Selecione o arquivo extraido da maleta:"))
        self.botao_extraido.setText(_translate("MainWindow", "Buscar Arquivo"))
        self.label_2.setText(_translate("MainWindow", "Selecione a lista de usuarios atualizada:"))
        self.botao_atualizada.setText(_translate("MainWindow", "Buscar Arquivo"))
        self.botao_gerar.setText(_translate("MainWindow", "Gerar Carga Massiva"))
